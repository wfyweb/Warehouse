var iClock = {
	createClock: function(){
		var obj = {};
		obj.str = "";
		obj.makeClock = function(){
			var today;   
			today = new Date();   
			document.getElementById("localtime").innerHTML = obj.tick(today);   
			window.setTimeout(obj.makeClock, 1000); 
		};
		obj.tick = function(objD){
			...
			if(ss<10) ss = '0' + ss;   
			var ww = objD.getDay();
			str = "<em>"+hh + "</em>:<em>" + mm + "</em>:<em>" + ss +"</em>";   
			return(str);   
		};
		return obj;
	}
...
var searchHtml = '<div class="searchbar2 searchbar3">'+
	'<div class="tab_all" id="wrapper2">'+
		'<ul id="scroller2" class="clearfix">'+
			'<li class="current"><a href="javascript:void(0);" class="item" data-val="1">文化资讯</a></li>'+
			'<li><a href="javascript:void(0);" class="item" data-val="2">通知公告</a></li>'+
			'<li><a href="javascript:void(0);" class="item" data-val="3">政策文件</a></li>'+
			'<li><a href="javascript:void(0);" class="item" data-val="4">产业动态</a></li>'+
			'<li><a href="javascript:void(0);" class="item" data-val="5">企业动态</a></li>'+
			'<li><a href="javascript:void(0);" class="item" data-val="6">文化企业</a></li>'+
		'</ul>'+
